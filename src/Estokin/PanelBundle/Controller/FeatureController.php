...
use Estokin\PanelBundle\Entity\Feature;
use Estokin\PanelBundle\Form\FeatureType;
...
class FeatureController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EstokinPanelBundle:Feature')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EstokinPanelBundle:Feature')->find($id);
     ...
     * @Method("post")
     * @Template("EstokinPanelBundle:Feature:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("EstokinPanelBundle:Feature:edit.html.twig")
     */
