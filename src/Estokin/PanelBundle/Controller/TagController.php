...
use Estokin\PanelBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EstokinPanelBundle:Tag')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EstokinPanelBundle:Tag')->find($id);
     ...
     * @Method("post")
     * @Template("EstokinPanelBundle:Tag:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("EstokinPanelBundle:Tag:edit.html.twig")
     */
